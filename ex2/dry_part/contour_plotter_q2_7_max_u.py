...
im = plt.imshow( ((f_1(x,y)<=0) & (f_2_max_u(x,y)<=0) & (f_3(x,y)<=0) & (f_4(x,y)<=0) & (f_5(x,y)<=0) & (f_6(x,y)<=0)).astype(int) , 
                extent=(x.min(),x.max(),y.min(),y.max()),origin="lower", cmap="Greys")


#For q2_7_u_max I already pre calculated the minimum point (https://www.wolframalpha.com/input/?i=min+0.5x-y%2C+-x%2By-1%3C%3D0%2C+-x%2F3%2By-5%2F3%3C%3D0%2C+x-4%3C%3D0%2C+y-3%3C%3D0%2C+x%3E%3D0%2C+y%3E%3D0)
min_x, min_y = 2,3
plt.plot(min_x, min_y, 'bo')
save_fig('q2_7_u_max.png')
