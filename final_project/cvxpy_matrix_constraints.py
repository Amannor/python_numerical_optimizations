...
# x_first_iter = pickle.load( open( os.path.join("concise_data", "x_first_iter.pkl"), "rb" ) )
# print(f'The value for of obj for x_first_iter {objective_function(x_first_iter, q, P)}')
# print(f'sum(x_first_iter) {sum(x_first_iter)}')
# print(f'x_first_iter {x_first_iter}')
